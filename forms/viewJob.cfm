...
<cfset orms_rec = orms.GetByTypeAndPK("Project", url.jobid)>
...
<body>
<cfquery name="j" datasource="webwarecl">
	SELECT * FROM projects WHERE id='#url.jobid#'
</cfquery>
<cfquery name="i" datasource="sites">
...
<table width="100%" border="0">
	<tr>
		<td rowspan="2">
			<img src="/SiteContent/#j.site_id#/#i.logo#" /><br>
			<img src="http://picasso.coherent-logic.com:8500/repos/#orms_rec.r_owner#/Project/#orms_rec.r_id#/barcode.png">
		</td>
