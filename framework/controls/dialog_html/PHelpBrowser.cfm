...
<cfquery name="GetDocs" datasource="webwarecl">
	SELECT * FROM documents WHERE catalog_id=1 ORDER BY doc_title 
</cfquery>    

<cfquery name="GetCatalogs" datasource="webwarecl">
	SELECT * FROM help_catalogs ORDER BY id
</cfquery>


<div style="width:100%; height:100%; padding:0px;" class="PDMCommonDialogWhite">
