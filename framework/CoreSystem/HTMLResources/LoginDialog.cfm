	...
	<table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
        	...
        	<td align="right" style="background-color:black; color:white;">                            
    			<input type="button" class="normalButton" value="Log In" onclick="PAuthenticate(GetValue('UserName'), GetValue('Password'));"> <input type="button" class="normalButton" value="Reload Prefiniti" onclick="location.reload(true);" />
