...
function LoadFriends()
{
	...
	ClearUP();
	setClass('tab_friends', 'PTabButtonActive');
}
...
function LoadCoworkers(DepartmentID)
{
	...
	ClearUP();
	setClass('tab_coworkers', 'PTabButtonActive');
}
...
function LoadCustomers(SiteID)
{
	...
	ClearUP();
	setClass('tab_customers', 'PTabButtonActive');
}
...
function LoadSearch()
{
	...
	ClearUP();
	setClass('tab_search', 'PTabButtonActive');
}

function ClearUP() 
{
	try {
	setClass('tab_friends', 'PTabButtonInactive');
	} catch (ex) {}
	try {
	setClass('tab_coworkers', 'PTabButtonInactive');
	} catch(ex) {}
	try {
	setClass('tab_customers', 'PTabButtonInactive');
	} catch (ex) {}
	try {
	setClass('tab_search', 'PTabButtonInactive');
	} catch (ex) {}
}
