...
<cfquery name="toolbars" datasource="webwarecl">
	SELECT * FROM installed_toolbars WHERE user_id=#url.calledbyuser#
</cfquery>

<cfif toolbars.RecordCount LT 1>
	<cfquery name="SetUpToolbars" datasource="webwarecl">
		INSERT INTO installed_toolbars (user_id, toolbar_id)
		VALUES	(#url.calledbyuser#, 1)
	</cfquery>
	<cfquery name="SetUpToolbars2" datasource="webwarecl">
		INSERT INTO installed_toolbars (user_id, toolbar_id)
		VALUES	(#url.calledbyuser#, 2)
	</cfquery>
	<cfquery name="SetUpToolbars3" datasource="webwarecl">
		INSERT INTO installed_toolbars (user_id, toolbar_id)
		VALUES	(#url.calledbyuser#, 3)
	</cfquery>
	<cfquery name="SetUpToolbars4" datasource="webwarecl">
		INSERT INTO installed_toolbars (user_id, toolbar_id)
		VALUES	(#url.calledbyuser#, 4)
	</cfquery>
	<cfquery name="SetUpToolbars5" datasource="webwarecl">
		INSERT INTO installed_toolbars (user_id, toolbar_id)
		VALUES	(#url.calledbyuser#, 5)
	</cfquery>
	<cfquery name="SetUpToolbars6" datasource="webwarecl">
		INSERT INTO installed_toolbars (user_id, toolbar_id)
		VALUES	(#url.calledbyuser#, 6)
	</cfquery>
	<cfquery name="SetUpToolbars7" datasource="webwarecl">
		INSERT INTO installed_toolbars (user_id, toolbar_id)
		VALUES	(#url.calledbyuser#, 7)
	</cfquery>
	<cfquery name="SetUpToolbars8" datasource="webwarecl">
		INSERT INTO installed_toolbars (user_id, toolbar_id)
...
<cfquery name="fwb" datasource="webwarecl">
