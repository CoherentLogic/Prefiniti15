...
<cfoutput>
    ...
    <input type="button" id="#URL.ConversationID#_Send" value="Send" onclick="CFindConversationByID ('#URL.ConversationID#').SendIM(GetValue('#URL.ConversationID#_Text')); SetValue('#URL.ConversationID#_Text', '');">
</cfoutput>    
