...
<cfoutput>
	...
	<cfif getPermissionByKey("CT_PROCESSPAYMENTS", attributes.QueriedAssociation)>
		<cfif s.orders0 GT 0>
			<img src="/graphics/AppIconResources/crystal_project/16x16/actions/project_open.png"  width="16" height="16"  align="absmiddle" onclick="window.open('https://www.prefiniti.com/framework/OrderProcess/Master.cfm?VendorID=#URL.Current_Site_ID#&userid=#URL.CalledByUser#');" onmouseover="Tip('#s.orders0# unacknowledged orders');" onmouseout="UnTip();" />
