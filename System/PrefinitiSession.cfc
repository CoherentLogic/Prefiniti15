<!--- 
	...
	PrefinitiSession.cfc
	 The Prefiniti Session object
...
<cfcomponent displayName="PrefinitiSession" hint="The Prefiniti session object" extends="System.Framework">
    ...
    <cffunction name="Open" displayName="Open" hint="Open a Prefiniti session" access="public" returnType="System.PrefinitiSession" output="false">
        ...
        <cfif qryChkCred.password EQ this.HashedPassword>
            ...
            <cfset this.ActiveMembership = createObject("component", "System.SiteMembership").LoadByID(qryChkCred.last_site_id)>
            
            <cfset this.DBKey = qryRetrieveSession.id>   
            
            <cflog file="System.PrefinitiSession" type="information" text="#this.Username#:SecurityAudit:Success:#this.NetAddress#:#this.SessionToken#">                                       
	...
	<cffunction name="Close" displayName="Close" hint="Close the session, releasing the session token." access="public" returnType="System.PrefinitiSession" output="false">
    	<cfset this.SessionToken = "">
        <cfset this.Active = 0>
        <cfset this.Authenticated = false>
