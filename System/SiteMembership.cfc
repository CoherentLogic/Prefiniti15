...
<cfcomponent displayName="SiteMembership" hint="Encapsulates a membership to a Prefiniti site" extends="System.Framework">
    ...
    <cffunction name="Create" displayName="Create" hint="Create a new site membership" access="public" returnType="System.SiteMembership" output="false">
		<!--- Create body --->
		<cfreturn #this#>
	</cffunction>
    
    <cffunction name="Load" displayname="Load" hint="Load an existing site membership from the database" access="public" returntype="System.SiteMembership" output="false">
        ...
        <cfset this.Site = createObject("component", "System.Site").Open(this.SiteName)>
        
        <cfreturn #this#>
    </cffunction>
    
    <cffunction name="LoadByID" displayname="LoadByID" hint="Load an existing site membership from the database by membership ID" access="public" returntype="System.SiteMembership" output="false">
        ...
        <cfset this.Site = createObject("component", "System.Site").Open(this.SiteName)>
        <cfcatch>
        	<cflog file="System.SiteMembership" type="error" text="Message: #cfcatch.Message#">
        	<cflog file="System.SiteMembership" type="error" text="Detail: #cfcatch.Detail#">
        </cfcatch>
        </cftry>
        <cfreturn #this#>
    </cffunction>
    ...
    <cffunction name="InstalledApps" hint="Return an array of structures representing all installed apps." access="public" returntype="array" output="no">
        ...
        <cfoutput query="qryInstalledApps">
        	<cfset appObj = createObject("component", "System.App").Open(AppID)>
    ...
    <cffunction name="Enumerate" displayname="Enumerate" hint="Enumerate site memberships for a user." access="public" returntype="query" output="false">
    	<cfargument name="User" type="System.User" required="yes">
