<cfquery name="locDetails" datasource="webwarecl">
	...
	<table class="ldT">
		...
		<tr>
        	...
        	<td colspan="2" align="left">
            	...
            	<img src="/graphics/map_add.png" align="absmiddle" /> <a href="javascript:showAddress(GetValue('m_address') + ' ' + GetValue('m_city') + ', ' + GetValue('m_state') + ' ' + GetValue('m_zip'), GetValue('loc_name'), true);">Add to Map</a><br />
