...
<cffunction name="getDirectorySize" returntype="numeric">
    ...
    <cfdirectory action="list" directory="D:\Inetpub\Prefiniti15\UserContent\#getUsername(user_id)#\#basedir#\" name="p">
...
<cffunction name="cmsUserFilePath" returntype="string">
    ...
    <cfset tmp="D:/Inetpub/Prefiniti15/UserContent/#getUsername(cufp.user_id)#/#cufp.basedir#/#cufp.filename#">
...
<cffunction name="cmsSiteFilePath" returntype="string">
    ...
    <cfset tmp="D:\Inetpub\Prefiniti15\SiteContent\#cssfp.site_id#\#cssfp.basedir#">
...
<cffunction name="cmsUserFileBasePath" returntype="string">
    ...
    <cfset tmp="D:\Inetpub\Prefiniti15\UserContent\#getUsername(cufp.user_id)#\#cufp.basedir#">
...
<cffunction name="cmsSiteFileBasePath" returntype="string">
    ...
    <cfset tmp="D:\Inetpub\Prefiniti15\SiteContent\#site_id#\#csfp.basedir#">
...
<cffunction name="cmsUserBasePath" returntype="string">
    ...
    <cfparam name="tmp" default="">
    <cfset tmp="D:\Inetpub\Prefiniti15\UserContent\#getUsername(user_id)#">
...
<cffunction name="cmsSiteBasePath" returntype="string">
    ...
    <cfparam name="tmp" default="">
    <cfset tmp="D:\Inetpub\Prefiniti15\SiteContent\#site_id#">
...
<cffunction name="cmsUserFileURLNoEnc" returntype="string">
	<cfargument name="file_id" required="yes" type="numeric">
    
    <cfparam name="tmp" default="">
    
    <cfquery name="cufune" datasource="webware_cms">
    	SELECT * FROM user_files WHERE id=#file_id#
	</cfquery>
    
    <cfset tmp="http://prefiniti15.prefiniti.com/UserContent/#getUsername(cufune.user_id)#/#cufune.basedir#/#cufune.filename#">
...
<cffunction name="cmsCreateUserFile" returntype="numeric">
    ...
    <cfquery name="ccrf_gi" datasource="webware_cms">
...
<cffunction name="cmsCreateSiteFile" returntype="numeric">
	...
	<cfquery name="GruntingHippos" datasource="webware_cms">
...
<cffunction name="cmsCreateFileAssociation" returntype="void">
    ...
    <cfquery name="ccfagp" datasource="webwarecl">
