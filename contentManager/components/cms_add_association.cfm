...
<cfquery name="projects_by_user" datasource="webwarecl">
	...
	<cfoutput>
    	...
    	<table width="100%" class="faTable">
            ...
            <td colspan="2" align="center" style="text-align:center;">
            	<input type="button" class="normalButton" name="fsa_cancel" onclick="p_session.Framework.PostLocalMessage('Associate-File', IWC_REQUESTCLOSE, C_WINDOWMANAGER, null);" value="Cancel">
                <cfoutput>
