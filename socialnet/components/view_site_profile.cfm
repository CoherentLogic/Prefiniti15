...
<cfquery name="ass_count" datasource="sites">
	SELECT * 
...
<cfmodule template="/orms/view_header.cfm" r_type="Site" r_pk="#url.site_id#">
<cfset po = CreateObject("component","Res").GetByTypeAndPK("Site", url.site_id)>
