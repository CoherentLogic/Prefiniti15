...
<cfoutput><strong style="font-weight:bold; color:##3399CC">#DateFormat(attributes.date, "dddd mmmm d, yyyy")#</strong>
</cfoutput><table width="100%" cellspacing="0" cellpadding="0" style="clear:left;" class="timeTable">
<tr>
	<th>Time</th>
...
<cfloop index="i" from="1" to="96" step="4">
    ...
    <cfoutput>
	<tr>
    	<td rowspan="5" width="80" style="border-bottom:1px solid ##C0C0C0; background-color:#shading#; color:##3399CC; font-size:small; font-weight:bold;" nowrap><cfoutput>#times[i]#<br /><cfmodule template="/employees/CheckShifts.cfm" beginBlock="#i#" date="#attributes.date#" user_id="#URL.calledByUser#"></cfoutput></td>
    </tr>
