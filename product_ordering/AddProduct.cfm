...
<form name="AddProduct" id="AddProduct">
	<input type="hidden" name="site_id" value="#url.current_site_id#" id="site_id" />
	<table width="100%">
	<tr>
		<td>Product Name:</td>
	...
	<tr>
		<td colspan="2" align="right">
			<input type="button" name="submit" value="Add This Item" onclick="AjaxSubmitForm(AjaxGetElementReference('AddProduct'), '/product_ordering/AddProduct_Submit.cfm', 'tcTarget');">
		</td>
	</tr>
	</table>						
</form>
