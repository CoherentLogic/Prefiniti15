...
<div id="weekCal">
<cfmodule template="/controls/weekCalendarOld.cfm" viewer="/jobViews/priorityByDay.cfm" showWeekend="false" startDate="firstDayOfWeek">
</div>
    ...
    <table width="100%" cellspacing="0" class="pList">
        ...
        <cfoutput query="pp">
            ...
            <tr>
                ...
                <td style="background-color:#ColColor#"><img src="graphics/zoom.png" border="0" align="absmiddle"> <a href="javascript:loadProjectViewer(#id#);">View</a><br />
                <img src="graphics/zoom.png" border="0" align="absmiddle"> <a href="/workFlow/PPM/View.cfm?ppm_project_id=#id#&site_id=#url.current_site_id#&user_id=#url.calledByUser#" target="_blank">View (New)</a>
            </tr>
        </cfoutput>
    </table>
</cfif>
