...
<cfoutput>
<!--
<wwafcomponent>#UCase(Left(url.mailbox, 1))##Mid(url.mailbox, 2, Len(url.mailbox)-1)#</wwafcomponent>
<wwaficon>email.png</wwaficon>
-->

    <div style="height:40px;">
    
	<a class="button" href="javascript:writeMessage();"><span>Write Message</span></a> <a class="button" href="javascript:viewMailFolder('inbox', 1);"><span>Inbox</span></a> <a class="button" href="javascript:viewMailFolder('sent messages', 1);"><span>Sent Messages</span></a>
    </div>
...
<table width="100%" cellspacing="0" class="pretty-table">
	<tr>
		<th scope="col">&nbsp;</th>
		<th scope="col">
